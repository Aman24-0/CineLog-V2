...
import { signInWithEmail, signUpWithEmail, signInWithGoogle } from "~/shared/hooks/useAuthActions";
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ flex: 1, height: "1px", background: "var(--hairline, rgba(255,255,255,0.06))" }} />
              <span style={{ "font-size": "11px", color: "var(--text-muted, rgba(232,234,240,0.48))", "text-transform": "uppercase", "letter-spacing": "0.1em" }}>
                or
              </span>
              <div style={{ flex: 1, height: "1px", background: "var(--hairline, rgba(255,255,255,0.06))" }} />
            </div>
