...
//        body: { job: "refresh_admin_analytics" | "cinelog_purge_soft_deleted_vault" | "weekly_recap" | "release_reminders" }
//
// STRICT USER-SIDE MAPPING:
//   Only the pg_cron jobs actually created by supabase/migrations are
...
//     • release_reminders               — '0 * * * *'  (hourly)
//       migration: 20260826_release_reminder_scheduler.sql
//       upgrade: 20260827_release_reminder_hourly_schedule.sql
//
...
// The known pg_cron jobs (see file header for migration sources).
const KNOWN_JOBS: CronJob[] = [
  ...
  },
  {
    ...
    command: "SELECT net.http_post(...)", // generated by the setup function
    rpc: "",
    rpc_args: {},
    target_type: "http",
    http_endpoint: "/api/cron/release-reminders",
    description:
      "Delivers due release reminders with title, poster, and canonical detail URL to every subscribed device.",
    source_migration: "20260826_release_reminder_scheduler.sql + 20260827_release_reminder_hourly_schedule.sql"
  }
];
