...
const PrivacyRoute: Component = () => {
  ...
  const handleClearHistory = async () => {
    ...
    try {
      ...
      setBreakdown(getStorageBreakdown());
      showToast(removed > 0 ? `Cleared ${removed} search history entries` : "No search history to clear", "success", 1800);
    } catch (e) {
  ...
  const handleClearCache = async () => {
    ...
    try {
      ...
      setBreakdown(getStorageBreakdown());
      showToast(removed > 0 ? `Cleared ${removed} cache entries` : "No cache to clear", "success", 1800);
    } catch (e) {
        ...
        <div class="sec-page sec-fade-in">
          ...
          <div class="sec-body">
              ...
              <div class="setting-group">
                ...
                <div class="setting-row" style={{ cursor: "default" }}>
                  ...
                  <div class="setting-row-text">
                    ...
                    <span class="setting-row-desc">CineLog pages are not indexed by Google/Bing</span>
                  </div>
                  <span class="setting-row-value" style={{ color: "#4ade80" }}>Hidden</span>
                </div>
              </div>
            </section>
            ...
            <section class="sec-section">
              ...
              <div class="setting-group">
                <ToggleRow
                  ...
                  onChange={(v) => {
                    ...
                    showToast(v ? "Ratings will blur in app switcher" : "Ratings visible normally", "info", 1500);
                  }}
                />
              </div>
              <div class="info-callout" style={{ "margin-top": "var(--sp-3)" }}>
                ...
                <p class="info-callout-body">
                  <strong>How it works:</strong> When you switch away from CineLog (or open the app switcher), the browser fires a <code>visibilitychange</code> event. CineLog then adds a CSS class that blurs all rating pills + rating badges. When you come back, the blur is removed. This is best-effort — some platforms (iOS Safari) may not fire the event reliably.
                </p>
              </div>
            </section>
            ...
            <section class="sec-section">
              ...
              <div class="setting-group">
                <a href="/settings/content-discover" class="setting-row focus-ring" aria-label="Manage adult content filter">
                  <div class="setting-row-icon" aria-hidden="true">
                    <span class="material-symbols-outlined" style={{ "font-size": "18px" }} aria-hidden="true">no_adult_content</span>
                  </div>
                  <div class="setting-row-text">
                    <span class="setting-row-label">Adult content filter</span>
                    <span class="setting-row-desc">
                      Currently: <strong style={{ color: adultContentFilter() ? "#4ade80" : "var(--text-muted)" }}>{adultContentFilter() ? "On (hidden)" : "Off (visible)"}</strong>
                    </span>
                  </div>
              ...
              <div class="setting-group">
                <div class="setting-row" style={{ cursor: "default" }}>
                  ...
                  <div class="setting-row-text">
                    ...
                    <span class="setting-row-desc">{breakdown().searchHistoryKeys} entries · stored locally</span>
                  </div>
                  <button
                    type="button"
                    class="settings-link-btn focus-ring"
                    onClick={handleClearHistory}
                    disabled={clearingHistory() || breakdown().searchHistoryKeys === 0}
                  >
                    <Show when={!clearingHistory()} fallback="Clearing…">Clear</Show>
                  </button>
                </div>
                <div class="setting-row" style={{ cursor: "default" }}>
                  <div class="setting-row-icon" aria-hidden="true">
                  ...
                  <div class="setting-row-text">
                    ...
                    <span class="setting-row-desc">{breakdown().tmdbCacheKeys} entries · {formatBytes(breakdown().approxBytes)} total</span>
                  </div>
                  <button
                    type="button"
                    class="settings-link-btn focus-ring"
                  ...
                  >
                    <Show when={!clearingCache()} fallback="Clearing…">Clear</Show>
                  </button>
                </div>
              </div>
            </section>
              ...
              <div class="setting-group">
                <a href="/settings/sync" class="setting-row focus-ring" aria-label="Export your data">
                  ...
                  <div class="setting-row-text">
                    ...
                    <span class="setting-row-desc">Download your full watchlist as JSON or CSV</span>
                  </div>
                  <span class="material-symbols-outlined setting-row-chevron" aria-hidden="true">chevron_right</span>
                </a>
