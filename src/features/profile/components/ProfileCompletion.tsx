...
//
// Sprint 2B — Migrated to GlassSurface for surface treatment.
 ...
 * Uses GlassSurface for consistent glass treatment.
 */
const ProfileCompletion: Component<ProfileCompletionProps> = (props) => {
  ...
  return (
    <GlassSurface strength="default" border padding="comfortable" radius="lg">
