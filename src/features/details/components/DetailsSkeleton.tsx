    ...
    <div class="cinematic-modal modal-sheet-enter">
      <div class="cinematic-scroll">
        ...
        <div class="cinematic-hero">
          <div class="skeleton-base" style={{ position: "absolute", inset: 0, "border-radius": 0 }} />
        </div>
        ...
        <div class="hero-content-cluster">
          ...
          <div class="flex-1 pb-1">
            ...
            <Skeleton width="50%" height="0.875rem" variant="text" style={{ "margin-top": "0.5rem" }} />
            <div class="flex gap-2 mt-3">
              <Skeleton width="60px" height="1.25rem" radius="var(--radius-pill)" />
              <Skeleton width="80px" height="1.25rem" radius="var(--radius-pill)" />
        ...
        <div class="detail-section" style={{ "margin-top": "1.5rem" }}>
          <Skeleton width="120px" height="0.75rem" variant="text" style={{ "margin-bottom": "0.75rem" }} />
          <Skeleton width="100%" height="4rem" />
        </div>

        <div class="detail-section">
          <Skeleton width="80px" height="0.75rem" variant="text" style={{ "margin-bottom": "0.75rem" }} />
