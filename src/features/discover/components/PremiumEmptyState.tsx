// src/features/discover/components/PremiumEmptyState.tsx
...
/**
 * PremiumEmptyState — uniform empty / error placeholder for Discover
 * sections.
 *
 * Why this exists:
 ...
 */
const PremiumEmptyState: Component<PremiumEmptyStateProps> = (props) => {
  return (
